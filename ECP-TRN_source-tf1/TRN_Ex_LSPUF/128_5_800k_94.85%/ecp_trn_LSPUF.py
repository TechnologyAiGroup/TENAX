...
df1 = pd.read_csv('./dataset/128_5_2200k_0.01_42_LSPUF.csv', header=None, chunksize=nSamples)
df1 = df1.get_chunk()
...
def main(rank=None, file=None, f_error=None, f_acc=None):
    with tf.Session() as sess:
        ...
        y1 = tf.placeholder(tf.float32, shape=[None, phi_length, phi_length, phi_length, phi_length, phi_length])
