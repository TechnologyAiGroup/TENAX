...
df1=pd.read_csv('./dataset/128_6_2000k_0.01_42_XORAPUF.csv',header=None,chunksize=nSamples)
df1 = df1.get_chunk()
...
def main(rank = None, file = None, f_error = None, f_acc = None):
	...
	with tf.Session() as sess:
		...
		train_step = tf.train.AdamOptimizer(500e-4).minimize(cross_entropy)
