...
df1=pd.read_csv('./dataset/64_8_31000k_0.01_46_XORAPUF.csv',header=None,chunksize=nSamples)
df1 = df1.get_chunk()
...
def main(rank = None, file = None, f_error = None, f_acc = None):
	...
	with tf.Session() as sess:
		...
		y1 = tf.placeholder(tf.float32, shape = [None, 65,65,65,65,65,65,65,65])
		...
		train_step = tf.train.AdamOptimizer(40e-4).minimize(cross_entropy)
