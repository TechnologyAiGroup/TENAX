...
df1=pd.read_csv('./dataset/128_5_1000k_0.01_43_XORAPUF.csv',header=None,chunksize=nSamples)
df1 = df1.get_chunk()
...
def main(rank = None, file = None, f_error = None, f_acc = None):
	...
	with tf.Session() as sess:
		...
		y1 = tf.placeholder(tf.float32, shape = [None, 129,129,129,129,129])
		...
		train_step = tf.train.AdamOptimizer(50e-4).minimize(cross_entropy)
