...
df1=pd.read_csv('./dataset/256_4_400k_0.01_42_XORAPUF.csv',header=None,chunksize=nSamples)
df1 = df1.get_chunk()
...
def main(rank = None, file = None, f_error = None, f_acc = None):
	...
	with tf.Session() as sess:
		...
		y1 = tf.placeholder(tf.float32, shape = [None, 257,257,257,257])
